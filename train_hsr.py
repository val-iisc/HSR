...
def setup_training_loop_kwargs(
    ...
    **kwargs,
    ...
    args.G_kwargs = dnnlib.EasyDict(class_name='training.networks.FeatureGuidedGenerator', z_dim=512, w_dim=512, mapping_kwargs=dnnlib.EasyDict(), synthesis_kwargs=dnnlib.EasyDict())
    ...
    args.loss_kwargs = dnnlib.EasyDict(class_name='training.loss.StyleGAN2HSR', r1_gamma=spec.gamma, model_name=model_name, batch_size=spec.mb)
...
def get_args_parser():
    ...
    parser.add_argument('--model-name', type=click.Choice(['DINO', 'DeiT', 'ResNet50', 'ResNet50DINO']))
