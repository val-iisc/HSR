...
from training import training_loop_baseline as training_loop
...
def setup_training_loop_kwargs(
    ...
    **kwargs,
    ...
    cfg_specs = {
        ...
        'paper256_orig':  dict(ref_gpus=8,  kimg=25000,  mb=64, mbstd=8,  fmaps=0.5, lrate=0.002, gamma=1,    ema=10,  ramp=None, map=8),
    }
...
def get_args_parser():
    ...
    # Base config.
    parser.add_argument('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', 'stylegan2', 'paper256', 'paper256_2fmap', 'paper256_orig', 'paper512', 'paper1024', 'cifar']))
